...
class BookmarksFragment : Fragment() {
    ...
    private fun setupUI() {
        ...
        bookmarksAdapter = BookmarksAdapter(
            onBookmarkClick = { bookmark -> navigateToSection(bookmark) },
    ...
    private fun setupObservers() {
        ...
        viewModel.empty.observe(viewLifecycleOwner) { isEmpty ->
            binding.emptyView.root.isVisible = isEmpty && !binding.progressBar.isVisible && !binding.errorView.root.isVisible
        }
    }
