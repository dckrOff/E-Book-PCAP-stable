...
interface ChapterDao {
    ...
    @Query("SELECT c.* FROM chapters c INNER JOIN recent_chapters rc ON c.id = rc.chapterId ORDER BY rc.lastViewedAt DESC LIMIT :limit")
    fun getRecentChapters(limit: Int): Flow<List<ChapterEntity>>
